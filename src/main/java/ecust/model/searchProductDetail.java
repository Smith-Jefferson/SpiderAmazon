...
public class searchProductDetail  extends searchProduct{
	...
	public searchProductDetail(String asin, double best_sellers_rank,double sellers_count, double review_count, double best_review,
	...
	public String toString() {
		return "Product [详情：asin=" + getAsin() +"]";
	}
